...
export const SYMBOLS = [
  { label: 'h', title: 'Hammer-on' },
  { label: 'p', title: 'Pull-off' },
  { label: '⤴', title: 'Bend' },
  { label: '⤵', title: 'Release' },
  { label: '/', title: 'Slide up' },
  { label: '\\', title: 'Slide down' },
  { label: '~', title: 'Vibrato' },
  { label: 'x', title: 'Muted' },
];
...
export const ICONS = {
  ...
  Duplicate: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/>
      <rect x="2" y="2" width="13" height="13" rx="2" ry="2" opacity="0.4"/>
    </svg>
  ),
  Space: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M18 13v6a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-6"/><path d="M21 9l-9 9-9-9"/>
    </svg>
  ),
};
